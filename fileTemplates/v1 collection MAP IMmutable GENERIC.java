...
//  class                              
//////////////////////////////////////////////////////////////////////////////////
//<editor-fold desc="class IMmutable">
/*
...
*   class
    ...
    1) reformat code
    2) replace all < KEY,VALUE > with "" ,besides replaceAll( UnaryOperator< KEY > operator )
    3) replace all <> with ""           (click MATCH CASE)
    4) uncomment < Type1,Type2 >
    5) replace all KEY with Type1
    6) replace all VALUE with Type2
...
* }</pre>
*/                                                            
public class ${NAME} <KEY,VALUE>
    extends HashMap< KEY,VALUE > /*< Type1,Type2 >*/
	...
	*   uses PUT method ot SUPER class
    ...
    * }</pre>
    */ 
	public static <KEY,VALUE> ${NAME}<KEY,VALUE> ofEntries( Entry<? extends KEY, ? extends VALUE>... entries )
		{
    ...
    * }</pre>
    */ 
	public ${NAME}(Map<? extends KEY, ? extends VALUE> map )
		{
		super( map );
		}
    ...
    * }</pre>
    */ 
	public static  <KEY,VALUE> ${NAME}<KEY,VALUE> newMap(Map<? extends KEY, ? extends VALUE> map  )
		{
    ...
    * }</pre>
    */ 
    public static <KEY, VALUE> ${NAME}<KEY, VALUE> of() {
        return new ${NAME}<>();
    }
    ...
    * }</pre>
    */ 
    public static <KEY, VALUE> ${NAME}<KEY, VALUE> of(KEY k1, VALUE v1) {
    ...
    * }</pre>
    */ 
    public static <KEY, VALUE> ${NAME}<KEY, VALUE> of(KEY k1, VALUE v1, KEY k2, VALUE v2) {
    ...
    * }</pre>
    */ 
    public static <KEY, VALUE> ${NAME}<KEY, VALUE> of(KEY k1, VALUE v1, KEY k2, VALUE v2, KEY k3, VALUE v3) {
    ...
    * }</pre>
    */ 
    public static <KEY, VALUE> ${NAME}<KEY, VALUE> of(KEY k1, VALUE v1, KEY k2, VALUE v2, KEY k3, VALUE v3, KEY k4, VALUE v4) {
    ...
    * }</pre>
    */ 
    public static <KEY, VALUE> ${NAME}<KEY, VALUE> of(KEY k1, VALUE v1, KEY k2, VALUE v2, KEY k3, VALUE v3, KEY k4, VALUE v4, KEY k5, VALUE v5) {
    ...
    */         
        @Override
        @Deprecated 
        final public VALUE compute(KEY key, BiFunction<? super KEY,? super VALUE,? extends VALUE> rf) { throw exception_(); }
    ...
    */        
        @Override 
        @Deprecated
        final public VALUE computeIfAbsent(KEY key, Function<? super KEY,? extends VALUE> mf) { throw exception_(); }
    ...
    */        
        @Override 
        @Deprecated
        final public VALUE computeIfPresent(KEY key, BiFunction<? super KEY,? super VALUE,? extends VALUE> rf) { throw exception_(); }
    ...
    */         
        @Override 
        @Deprecated
        final public VALUE merge(KEY key, VALUE value, BiFunction<? super VALUE,? super VALUE,? extends VALUE> rf) { throw exception_(); }
    ...
    */         
        @Override 
        @Deprecated
        final public VALUE put(KEY key, VALUE value) { throw exception_();}
    ...
    */        
        @Override
        @Deprecated
        final  public void putAll(Map<? extends KEY,? extends VALUE> m) { throw exception_();}
    ...
    */        
        @Override
        @Deprecated
        final  public VALUE putIfAbsent(KEY key, VALUE value) { throw exception_(); }
    ...
    */         
        @Override 
        @Deprecated
        final public VALUE remove(Object key) { throw exception_(); }
    ...
    */        
        @Override
        @Deprecated
        final  public VALUE replace(KEY key, VALUE value) { throw exception_(); }
    ...
    */         
        @Override 
        @Deprecated
        final public boolean replace(KEY key, VALUE oldValue, VALUE newValue) { throw exception_(); }
    ...
    */       
        @Override 
        @Deprecated
        final public void replaceAll(BiFunction<? super KEY,? super VALUE,? extends VALUE> f) { throw exception_(); }
