...
public class ${NAME}  
	...
	*/
	...
	private static final ${NAME} emptyInstance = new ${NAME}( ) ;
    ...
    * }</pre>
    */ 
	public static    ${NAME} newMap(Map<? extends KEY, ? extends VALUE> map  )
		{
    ...
    //<editor-fold des="helper function">
    /*                         
	*   helper function
	*   Analogically to List.of   
	*                      
    ...
    */ 
     @Override 
     @Deprecated
     final public void clear() { throw exception_(); }
