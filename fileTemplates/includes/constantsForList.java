    ...
    private String  elementIsNullMessage_(String ...messages)
        {
        return ELEMENT_IS_NULL_MESSAGE_;
        }
    private String  elementIsDefaultMessage_(String ...messages)
        {
        return ELEMENT_IS_DEFAULT_MESSAGE_;
        }
    private String  emptyCollectionMessage_(String ...messages)
        {
